...
class _$RequestModelImpl implements _RequestModel {
  ...
  @override
  String toString() {
    return 'RequestModel(id: $id, user: $user, name: $name, eventType: $eventType, amount: $amount, status: $status, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _RequestModel implements RequestModel {
  const factory _RequestModel({
    ...
    @JsonKey(name: 'user') final dynamic user,
